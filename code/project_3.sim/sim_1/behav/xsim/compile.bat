...
REM
REM Generated by Vivado on Mon Mar 07 23:28:15 +0800 2022
...
echo "xvlog --incr --relax -prj myALU_test_vlog.prj"
call xvlog  --incr --relax -prj myALU_test_vlog.prj -log xvlog.log
